...
for j in ${arrayFlow[*]};
    do
    ssh -p 10022 sternsdo@172.16.0.1 "mkdir /srv/testbed/results/manual_test_sternsdo/OVSFirewalltestMaxPacketsizeLowRulesFlow$j/"
    export DIRTEST=/srv/testbed/results/manual_test_sternsdo/OVSFirewalltestMaxPacketsizeLowRulesFlow$j/
        for i in ${array[*]};
        do
                cd /root/MoonGen
