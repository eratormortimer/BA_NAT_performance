...
\end{figure}
Figure \ref{fig:TrafficOVSNATtestMinimalPacketsizeFlow100TR400} has a similar peak to Figure \ref{fig:TrafficOVSNATtestMinimalPacketsizeFlow10000TR400}. But in the test with 10000 flows the average latency is higher as we a small amount of packets with high latency values. 
