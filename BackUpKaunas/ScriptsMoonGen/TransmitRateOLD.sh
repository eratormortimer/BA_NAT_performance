...
do
    ...
    echo "$(./build/MoonGen ./examples/l3-load-latency.lua -s 1500 -r $i -f 2000 1 0 & sleep 60 ; kill -INT $!)" >> output
    echo "finished with Moongen"
    sleep 20
    echo "end $(date)" >> output
    scp -P 10022 output sternsdo@172.16.0.1:/srv/testbed/results/manual_test_sternsdo/TransmitRate$DATE/output-send$n
    scp -P 10022 histogram.csv sternsdo@172.16.0.1:/srv/testbed/results/manual_test_sternsdo/TransmitRate$DATE/hist$n.csv
