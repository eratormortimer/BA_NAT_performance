 ...
 * itself, but you need to use "ethtool -L combined 3" with dpdk yourself.
 *
...
teth2 :: ToDPDKDevice(dpdk:eth2 , BURST $bout, IQUEUE $i, BLOCKING true)
teth3 :: ToDPDKDevice(dpdk:eth3 , BURST $bout, IQUEUE $i, BLOCKING true)
teth4 :: ToDPDKDevice(dpdk:eth4 , BURST $bout, IQUEUE $i, BLOCKING true)
teth5 :: ToDPDKDevice(dpdk:eth5 , BURST $bout, IQUEUE $i, BLOCKING true)

input0 :: Input(dpdk:eth2, 10.1.0.1, 90:e2:ba:46:f2:d4);
input1 :: Input(dpdk:eth3, 10.2.0.1, 90:e2:ba:46:f2:d5);
input2 :: Input(dpdk:eth4, 10.3.0.1, 90:e2:ba:46:f2:e0);
input3 :: Input(dpdk:eth5, 10.4.0.1, 90:e2:ba:46:f2:e1);
